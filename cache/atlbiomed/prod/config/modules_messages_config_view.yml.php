...
if ($templateName.$this->viewName == 'indexSuccess')
{
  ...
  $response->addStylesheet('messages', '', array ());
  $response->addJavascript('scriptaculous/lib/prototype.js');
  $response->addJavascript('scriptaculous/src/effects.js');
  $response->addJavascript('validation');
  $response->addJavascript('autotab');
}
else
{
  if (!$context->getRequest()->isXmlHttpRequest())
